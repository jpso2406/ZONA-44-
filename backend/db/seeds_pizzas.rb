# Seeds para el Sistema de Pizzas
...
# Crear bordes de queso
puts "🧀 Creando bordes de queso..."
borde_queso_precios = {
  'Personal' => 10_000,
  'Small' => 14_000,
  'Medium' => 20_000,
...
borde_queso_precios.each do |tamano_nombre, precio|
  tamano = TamanoPizza.find_by(nombre: tamano_nombre)
  BordeQueso.find_or_create_by!(tamano_pizza: tamano) do |bq|
    bq.precio = precio
  end
end
...
# Crear adicionales (si no existen)
puts "➕ Creando adicionales..."
adicionales = [
  { nombre: 'Piña', precios: { 'Personal' => 5_000, 'Small' => 6_000, 'Medium' => 9_000, 'Large' => 10_000 } },
  { nombre: 'Maíz', precios: { 'Personal' => 5_000, 'Small' => 7_000, 'Medium' => 10_000, 'Large' => 10_000 } },
  { nombre: 'Champiñón', precios: { 'Personal' => 5_000, 'Small' => 7_000, 'Medium' => 10_000, 'Large' => 14_000 } },
  { nombre: 'Tocinetta', precios: { 'Personal' => 5_000, 'Small' => 7_000, 'Medium' => 10_000, 'Large' => 14_000 } }
]

adicionales.each do |adicional_data|
  adicional = Adicional.find_or_create_by!(ingredientes: adicional_data[:nombre])
  
  # Crear precios por tamaño para adicionales
  adicional_data[:precios].each do |tamano_nombre, precio|
    tamano = TamanoPizza.find_by(nombre: tamano_nombre)
    # Aquí necesitarías crear una tabla adicional_tamanos si quieres manejar precios por tamaño
    # Por ahora, usaremos el campo precio existente en Adicional
  end
end
...
puts "   - #{BordeQueso.count} bordes de queso"
